 ...
 * 更多資訊可參考原作者文章http://softmenlouis.blogspot.com/2017/04/blog-post_74.html
 */
...
(function () {
  ...
  $(document).on("focus",".datepickerTW",function(){
  ...
  $(document).on("focus",".datepickerTWSearchFrom",function(){
    $(".datepickerTWSearchFrom").datepickerTW({
        changeYear: true,
        changeMonth: true,
        dateFormat: "yy-mm-dd",
      });
  ...
  $(document).on("focus",".datepickerTWSearchTo",function(){
    $(".datepickerTWSearchTo").datepickerTW({
        changeYear: true,
        changeMonth: true,
        dateFormat: "yy-mm-dd",
      });
